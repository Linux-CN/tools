	...
	<div class="navbar-top d-none d-lg-block small">
		<div class="container">
			<div class="d-md-flex justify-content-between align-items-center my-2">
				...
				<ul class="nav">
					<li class="nav-item">
						<a class="nav-link ps-0" href="about-us.html">关于</a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link" href="signin.html">登录/注册</a>
					</li>
				</ul>
				<!-- Top bar right -->
				<div class="d-flex align-items-center">
					...
					<div class="btn-group me-2" role="group" aria-label="font size changer">
						...
						<label class="btn btn-xs btn-outline-primary mb-0" for="font-default">正常</label>
					...
					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link px-2 fs-5" href="#"><i class="fab fa-github"></i></a>
						</li>
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<li class="nav-item dropdown dropdown-fullwidth">
						<a class="nav-link dropdown-toggle" href="#" id="megaMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 技术</a>
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">新闻</a>
					...
					<!-- Nav item 3 Post -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="postMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">观点</a>
...
<!-- Nav item 3 Post -->
					...
					<!-- Nav item 5 link-->
					<li class="nav-item"> <a class="nav-link" href="dashboard.html">LCTT</a></li>
				</ul>
			</div>
			<!-- Main navbar END -->
			...
			<div class="nav flex-nowrap align-items-center">
				...
				<div class="nav-item d-none d-md-block">
					<a href="#" class="btn btn-sm btn-warning mb-0 mx-2"><i class="bi bi-rss-fill"></i> 订阅!</a>
				</div>
				<!-- Nav Search -->
				<div class="nav-item dropdown dropdown-toggle-icon-none nav-search">
					...
					<div class="dropdown-menu dropdown-menu-end shadow rounded p-2" aria-labelledby="navSearch">
						<form class="input-group" method="GET" action="/search">
							<input class="form-control border-success" type="search" name="q" placeholder="Search" aria-label="Search">
							<button class="btn btn-success m-0" type="submit">搜索</button>
						</form>
					</div>
				</div>
